...
def modify_group_state(group_id, state, color, saturation, brightness, transition_time):
    group_url = f"{base_url}/groups/{group_id}/action"
    group_data = {"on": state, "bri": brightness, "hue": color, "sat": saturation, "transitiontime": transition_time}
